    ...
    <secsion class="top">
        <div class="container">
            <div class="row">
                ...
                <div class="top-logo">
                    <a href="index.php"><img style="width:150px; height:60px;" src="image/logovlu1.png" alt=""></a>
                </div>
                    ...
                    <ul>
                        ...
                        <li><?php echo $result['danhmuc_ten'] ?>
                            <ul class="top-menu-item">
                                    ...
                                    ?>
                                    <li><a href="cartegory.php?loaisanpham_id=<?php echo $result['loaisanpham_id'] 
                                    ?>"><?php echo $result['loaisanpham_ten'] ?></a></li>
                                    <?php
                                     } }
                                    ?>
                            </ul>

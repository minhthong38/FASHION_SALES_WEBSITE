...
?>
    ...
    <section class="detail">
           ...
           <div class="detail-top">
            ...
            <h1>Mã đơn hàng:<span style="font-size: 20px; color: #378000;">VLU<?php $ma = substr($session_id,0,8); echo $ma   ?></span></h1>
            ...
            <br>
            <p style="text-align: center;">Mọi thắc mắc quý khách vui lòng liên hệ hotline <span  style="font-size: 20px; color: red;">0987 654 321 </span> hoặc chat với kênh hỗ trợ trên website để được hỗ trợ nhanh nhất.</p>
           </div>
    </section>

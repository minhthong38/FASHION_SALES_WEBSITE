...
<section class="admin-content row space-between" >
        <div style="background-color:grey;" class="admin-content-left">
        <div class="header-top-left">
            <a href="index.php"><p style="color:black;">ADMIN</p></a>
        </div>
            <ul>
                <li><a href="#"> <img style="width:20px" src="icon/hi.png" alt="">Chào:  <span style="color:white; font-size:22px"><?php echo Session::get('admin_name') ?></span><span style="color: black; font-size:20px"> &#10084;</span></a>
